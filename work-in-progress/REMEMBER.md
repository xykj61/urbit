...
**Last refreshed:** `20260719.163945` (Eastern) · voice Quin  
**Product nib:** ZETA6 · LULU0–5 · **SETU6.5** · HOLD0–HOLD1 · HOLD-W  
**Language nib:** **STOA0–52** GREEN · STOA53 open  
**Suite nib:** ZETA0–6 · LULU0–5 · SETU0–SETU6.5 · HOLD0–HOLD1 · HOLD-W · STOA0–52  
**Git nib:** *(pin after seat)* STOA52 bind→inline nest-both cue-of-jam  
...
**STOA52** bind→inline nest-both cue-of-jam GREEN `20260719.163945` — authored faces into nest-both `(cue (jam (mix …) (mix …)))`. Next door: **STOA53** check-in.

Smoke: `rishi/bin/rishi run tools/glow_run.rish glow/gen/compose-bind-inline-nest-both-cue-jam.glow`

Pitfalls: right mix pair reuses left · expect = from ^ amount (**6**). Inline nest ladder closed.
...
| **STOA** | Glow language SLC · nest · composition | **STOA0–52 GREEN** · bind→inline nest-both · STOA53 next |
...
| Door | Kind |
|------|------|
| **STOA53** next language toward product-in-Glow | **check-in** |
