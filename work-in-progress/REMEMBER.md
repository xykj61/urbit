...
**Last refreshed:** `20260720.040200` (UTC cloud · Eastern season) · voice Quin  
**Product nib:** ZETA6 · LULU0–5 · **SETU6.5** · HOLD0–HOLD1 · HOLD-W  
**Language nib:** **STOA0–101** GREEN · STOA102 open  
**Suite nib:** ZETA0–6 · LULU0–5 · SETU0–SETU6.5 · HOLD0–HOLD1 · HOLD-W · STOA0–101  
**Git nib:** (refresh after send) STOA101 bartis argv sample  
...
**STOA101** GREEN · bartis argv sample — generator `gate-sample-u32.glow`.  
**STOA102** next — check-in (barket · body beyond identity · Sala B0).
...
| **STOA** | Glow language SLC · nest · composition | **STOA0–101 GREEN** · STOA102 next |
...
| Door | Kind |
|------|------|
| **STOA102** barket · body beyond identity · Sala B0 | **check-in** — iOS season |
