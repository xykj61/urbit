...
**Last refreshed:** `20260720.224734` (UTC cloud) · voice Quin  
**Product nib:** ZETA6 · LULU0–5 · **SETU6.5** · HOLD0–HOLD1 · HOLD-W  
**Language nib:** **STOA0–143** GREEN · STOA144 open  
**Suite nib:** ZETA0–6 · LULU0–5 · SETU0–SETU6.5 · HOLD0–HOLD1 · HOLD-W · STOA0–143  
**Git nib:** *(pin after send)* — STOA143 hepta-mold flip  
...
**STOA143** seated · hepta-mold flip (`%-  flip` · from↔amount · fee/nonce/memo/tag/to stay · 5/3/1/2/7/4/6 → 3/5/1/2/7/4/6).  
**Shape** seated as Glow OS surface word · mold stays Hoon study / desk suffix (`20260720.223226`).  
**STOA144** next — lean A map: **octa-mold** gate identity (Sala B0 Framework).
...
Hold on iOS: ambient gold · bartis stated · named allowlist amount/count/kind/xact/xfer/pair/triple/quad/penta/hexa/hepta · closed call gates double/inc/dec/flip. Defer Pixel/SETU / Sala B0 to Framework.
...
| **STOA** | Glow language SLC · nest · composition | **STOA0–143 GREEN** · STOA144 next |
...
| Door | Kind |
|------|------|
| **STOA144** octa-mold gate identity (lean A) · tagged argv · gold held | **open** — map next; Sala B0 Framework |
