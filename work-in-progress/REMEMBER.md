...
**Last refreshed:** `20260718.184537` (Eastern) · voice Quin  
**Product nib:** ZETA6 · LULU0–5 · **SETU5**  
**Suite nib:** ZETA0–6 · LULU0–5 · SETU0–SETU5  
...
| **SETU** | USB hearth carry Glass↔Desk | **SETU0–SETU5 GREEN** · SETU6 check-in |
...
| Door | Kind |
|------|------|
| Ship SETU5 device payload | **send** |
| **SETU6** QEMU/Pixel CDC-NCM lab | **check-in** |
