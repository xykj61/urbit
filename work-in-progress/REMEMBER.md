...
**Last refreshed:** `20260719.154112` (Eastern) · voice Quin  
**Product nib:** ZETA6 · LULU0–5 · **SETU6.5** · HOLD0–HOLD1 · HOLD-W  
**Language nib:** **STOA0–44** GREEN · STOA45 open  
**Suite nib:** ZETA0–6 · LULU0–5 · SETU0–SETU6.5 · HOLD0–HOLD1 · HOLD-W · STOA0–44  
**Git nib:** *(pin after seat)* STOA44 bind→nest-jam→cue  
...
**STOA44** bind→nest-jam→cue GREEN `20260719.154112` — authored faces into nest pack then cue. Next door: **STOA45** check-in.

Smoke: `rishi/bin/rishi run tools/glow_run.rish glow/gen/compose-bind-nest-jam-cue.glow`

Pitfalls: nest pack-right must reuse mix-right face · bind faces match mix pair · expect = amount (**3**).
...
| **STOA** | Glow language SLC · nest · composition | **STOA0–44 GREEN** · bind→nest-jam→cue · STOA45 next |
...
| Door | Kind |
|------|------|
| **STOA45** next language toward product-in-Glow | **check-in** |
