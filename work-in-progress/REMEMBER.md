...
**Last refreshed:** `20260719.204650` (Eastern) · voice Quin  
...
**Git nib:** `6a561a3358` Cursor iOS handoff · core polymorphism / port order  
...
**STOA89** GREEN · **STOA90** check-in lean **A** (pronunciation table G1) awaiting approve.  
...
Alphabet canon: [`../active-designing/20260719-204001_glow-rune-pronunciation-alphabet-riscv-and-generators.md`](../active-designing/20260719-204001_glow-rune-pronunciation-alphabet-riscv-and-generators.md).

Hold on iOS: closed table G1 · argv G3 · token lower · tidy mold. Defer Pixel/SETU adb to Framework outer terminal.
...
| **STOA** | Glow language SLC · nest · composition | **STOA0–89 GREEN** · STOA90 next |
...
| Door | Kind |
|------|------|
| **STOA90** pronunciation table G1 (lean A) | **check-in** — iOS season |
