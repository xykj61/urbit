...
**Last refreshed:** `20260720.040800` (UTC cloud · Eastern season) · voice Quin  
**Product nib:** ZETA6 · LULU0–5 · **SETU6.5** · HOLD0–HOLD1 · HOLD-W  
**Language nib:** **STOA0–103** GREEN · STOA104 open  
**Suite nib:** ZETA0–6 · LULU0–5 · SETU0–SETU6.5 · HOLD0–HOLD1 · HOLD-W · STOA0–103  
**Git nib:** (refresh after send) STOA103 bartis call-body double  
...
**STOA103** GREEN · bartis call body `%-  double  sample`.  
**STOA104** next — check-in (wider call-body set · nest · Sala B0).
...
Hold on iOS: wet/gold · `|^` tokenize/lower · open call-body gates. Defer Pixel/SETU / Sala B0 to Framework.
...
| **STOA** | Glow language SLC · nest · composition | **STOA0–103 GREEN** · STOA104 next |
...
| Door | Kind |
|------|------|
| **STOA104** wider call-body · nest · Sala B0 | **check-in** — iOS season |
