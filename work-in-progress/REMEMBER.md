...
**Last refreshed:** `20260719.153013` (Eastern) · voice Quin  
**Product nib:** ZETA6 · LULU0–5 · **SETU6.5** · HOLD0–HOLD1 · HOLD-W  
**Language nib:** **STOA0–42** GREEN · STOA43 open  
**Suite nib:** ZETA0–6 · LULU0–5 · SETU0–SETU6.5 · HOLD0–HOLD1 · HOLD-W · STOA0–42  
**Git nib:** *(pin after seat)* STOA42 cue nest jam both  
...
**STOA42** cue nest jam both GREEN `20260719.153013` — `(cue (jam (mix …) (mix …)))` under face · arms · open `++`. Nest-under-cue ladder closed. Next door: **STOA43** check-in.

Smoke: `rishi/bin/rishi run tools/glow_run.rish glow/gen/face-cue-jam-both-nest.glow`

Pitfalls: Zig `packed` → `cell_pack` · never shadow `rn` in `lower_null` · face expect **6** · core unpack **0** · MixEmitted 6 slots (both on both arms can overflow).
...
| **STOA** | Glow language SLC · nest · composition | **STOA0–42 GREEN** · cue nest jam both · STOA43 next |
...
| Door | Kind |
|------|------|
| **STOA43** next language toward product-in-Glow | **check-in** |
