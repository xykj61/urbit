...
**Last refreshed:** `20260719.171131` (Eastern) · voice Quin  
**Product nib:** ZETA6 · LULU0–5 · **SETU6.5** · HOLD0–HOLD1 · HOLD-W  
**Language nib:** **STOA0–59** GREEN · STOA60 open  
**Suite nib:** ZETA0–6 · LULU0–5 · SETU0–SETU6.5 · HOLD0–HOLD1 · HOLD-W · STOA0–59  
**Git nib:** *(pin after seat)* STOA59 `/+` nest-right cue-of-jam  
...
**STOA59** `/+` nest-right cue-of-jam GREEN `20260719.171131` — import `lib-core-cue-jam-right-nest`, call `unpack`. Next door: **STOA60** check-in.

Smoke: `rishi/bin/rishi run tools/glow_run.rish glow/gen/use-lib-cue-jam-right-nest.glow`

Pitfalls: right mix zeros the low half · expect **0**. Nest-both `/+` next natural door.
...
| **STOA** | Glow language SLC · nest · composition | **STOA0–59 GREEN** · `/+` nest-right cue-of-jam · STOA60 next |
...
| Door | Kind |
|------|------|
| **STOA60** next language toward product-in-Glow | **check-in** |
