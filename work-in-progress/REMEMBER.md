...
**Last refreshed:** `20260719.171844` (Eastern) · voice Quin  
**Product nib:** ZETA6 · LULU0–5 · **SETU6.5** · HOLD0–HOLD1 · HOLD-W  
**Language nib:** **STOA0–61** GREEN · STOA62 open  
**Suite nib:** ZETA0–6 · LULU0–5 · SETU0–SETU6.5 · HOLD0–HOLD1 · HOLD-W · STOA0–61  
**Git nib:** *(pin after seat)* STOA61 face→payload cue-of-jam  
...
**STOA61** face→payload cue-of-jam GREEN `20260719.171844` — outer `note` into payload arm `(cue (jam amount amount))`. Next door: **STOA62** check-in.

Smoke: `rishi/bin/rishi run tools/glow_run.rish glow/gen/compose-core-payload-cue-jam.glow`

Pitfalls: outer expect **7** · unpack expect **5**. Nest payload cue-jam / `/+` payload cue-jam stay later.
...
| **STOA** | Glow language SLC · nest · composition | **STOA0–61 GREEN** · face→payload cue-of-jam · STOA62 next |
...
| Door | Kind |
|------|------|
| **STOA62** next language toward product-in-Glow | **check-in** |
