...
**Last refreshed:** `20260720.222724` (UTC cloud) · voice Quin  
...
**Git nib:** *(pin after send)* — STOA141 hexa-mold flip  
...
**STOA141** seated · hexa-mold flip (`%-  flip` · from↔amount · fee/nonce/memo/tag stay · 5/3/1/2/7/4 → 3/5/1/2/7/4).  
...
Hold on iOS: ambient gold · bartis stated · named allowlist amount/count/kind/xact/xfer/pair/triple/quad/penta/hexa · closed call gates double/inc/dec/flip. Defer Pixel/SETU / Sala B0 to Framework.
...
| **STOA** | Glow language SLC · nest · composition | **STOA0–141 GREEN** · STOA142 next |
...
| Door | Kind |
|------|------|
| **STOA142** hepta-mold gate identity (lean A) · tagged argv · gold held | **open** — map next; Sala B0 Framework |
