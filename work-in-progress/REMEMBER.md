...
**Last refreshed:** `20260720.175029` (UTC cloud · Eastern season) · voice Quin  
...
**Git nib:** `6d02c6f968` STOA112 barket header parse on main  
...
**STOA112** sent · barket dry header parse (`BarketSpec` · `BodyNotYetLowered`).  
