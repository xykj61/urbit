...
**Last refreshed:** `20260719.161949` (Eastern) · voice Quin  
**Product nib:** ZETA6 · LULU0–5 · **SETU6.5** · HOLD0–HOLD1 · HOLD-W  
**Language nib:** **STOA0–48** GREEN · STOA49 open  
**Suite nib:** ZETA0–6 · LULU0–5 · SETU0–SETU6.5 · HOLD0–HOLD1 · HOLD-W · STOA0–48  
**Git nib:** *(pin after seat)* STOA48 four-bind nest-both jam→cue  
...
**STOA48** four-bind nest-both jam→cue GREEN `20260719.161949` — from · amount · payload · gate into nest-both pack then cue. Next door: **STOA49** check-in.

Smoke: `rishi/bin/rishi run tools/glow_run.rish glow/gen/compose-bind-nest-four-jam-cue.glow`

Pitfalls: distinct right mix needs six lines · two-bind distinct nest-both refused · expect = payload ^ gate (**8**).
...
| **STOA** | Glow language SLC · nest · composition | **STOA0–48 GREEN** · four-bind nest-both · STOA49 next |
...
| Door | Kind |
|------|------|
| **STOA49** next language toward product-in-Glow | **check-in** |
