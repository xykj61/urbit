...
**Last refreshed:** `20260719.231400` (Eastern) · voice Quin  
**Product nib:** ZETA6 · LULU0–5 · **SETU6.5** · HOLD0–HOLD1 · HOLD-W  
**Language nib:** **STOA0–96** GREEN · STOA97 open  
**Suite nib:** ZETA0–6 · LULU0–5 · SETU0–SETU6.5 · HOLD0–HOLD1 · HOLD-W · STOA0–96  
**Git nib:** (refresh after send) STOA96 TAME tidy lower_mold  
...
**STOA96** GREEN · `lower_mold` TAME tidy (assert · u32 · append_print · split).  
**STOA97** next — check-in (token→`MoldSpec` · Sala B0 · next language).
...
Hold on iOS: token→`MoldSpec` · Sala B0. Defer Pixel/SETU adb to Framework.
...
| **STOA** | Glow language SLC · nest · composition | **STOA0–96 GREEN** · STOA97 next |
...
| Door | Kind |
|------|------|
| **STOA97** token→`MoldSpec` · Sala B0 · next language | **check-in** — iOS season |
