...
**Last refreshed:** `20260719.153556` (Eastern) · voice Quin  
**Product nib:** ZETA6 · LULU0–5 · **SETU6.5** · HOLD0–HOLD1 · HOLD-W  
**Language nib:** **STOA0–43** GREEN · STOA44 open  
**Suite nib:** ZETA0–6 · LULU0–5 · SETU0–SETU6.5 · HOLD0–HOLD1 · HOLD-W · STOA0–43  
**Git nib:** *(pin after seat)* STOA43 bind→jam→cue  
...
**STOA43** bind→jam→cue GREEN `20260719.153556` — authored `from`/`amount` then pack/unpack. First product-shaped multi-line desk. Next door: **STOA44** check-in.

Smoke: `rishi/bin/rishi run tools/glow_run.rish glow/gen/compose-bind-jam-cue.glow`

Pitfalls: dispatch jam-cue for `n==2|4` before typed multi · bind faces must match jam faces · expect = authored amount (demo **3**).
...
| **STOA** | Glow language SLC · nest · composition | **STOA0–43 GREEN** · bind→jam→cue · STOA44 next |
...
| Door | Kind |
|------|------|
| **STOA44** next language toward product-in-Glow | **check-in** |
