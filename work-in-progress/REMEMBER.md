...
**Last refreshed:** `20260719.162549` (Eastern) · voice Quin  
**Product nib:** ZETA6 · LULU0–5 · **SETU6.5** · HOLD0–HOLD1 · HOLD-W  
**Language nib:** **STOA0–49** GREEN · STOA50 open  
**Suite nib:** ZETA0–6 · LULU0–5 · SETU0–SETU6.5 · HOLD0–HOLD1 · HOLD-W · STOA0–49  
**Git nib:** *(pin after seat)* STOA49 bind→inline cue-of-jam  
...
**STOA49** bind→inline cue-of-jam GREEN `20260719.162549` — authored faces into one-line `(cue (jam …))`. Next door: **STOA50** check-in.

Smoke: `rishi/bin/rishi run tools/glow_run.rish glow/gen/compose-bind-inline-cue-jam.glow`

Pitfalls: flat inline only · nest cue-of-jam under binds refused · expect = amount (**3**).
...
| **STOA** | Glow language SLC · nest · composition | **STOA0–49 GREEN** · bind→inline cue-of-jam · STOA50 next |
...
| Door | Kind |
|------|------|
| **STOA50** next language toward product-in-Glow | **check-in** |
