...
**Last refreshed:** `20260719.164640` (Eastern) · voice Quin  
**Product nib:** ZETA6 · LULU0–5 · **SETU6.5** · HOLD0–HOLD1 · HOLD-W  
**Language nib:** **STOA0–53** GREEN · STOA54 open  
**Suite nib:** ZETA0–6 · LULU0–5 · SETU0–SETU6.5 · HOLD0–HOLD1 · HOLD-W · STOA0–53  
**Git nib:** *(pin after seat)* STOA53 face→`|%` cue-of-jam  
...
**STOA53** face→`|%` cue-of-jam GREEN `20260719.164640` — outer face into open arm `(cue (jam sample sample))`. Next door: **STOA54** check-in.

Smoke: `rishi/bin/rishi run tools/glow_run.rish glow/gen/compose-core-cue-jam.glow`

Pitfalls: expect = sample low half (**5**). Nest / `/+` cue-jam compose stay later rungs.
...
| **STOA** | Glow language SLC · nest · composition | **STOA0–53 GREEN** · face→cue-of-jam `|%` · STOA54 next |
...
| Door | Kind |
|------|------|
| **STOA54** next language toward product-in-Glow | **check-in** |
