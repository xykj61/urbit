...
**Last refreshed:** `20260719.150811` (Eastern) · voice Quin  
**Product nib:** ZETA6 · LULU0–5 · **SETU6.5** · HOLD0–HOLD1 · HOLD-W  
**Language nib:** **STOA0–40** GREEN · STOA41 open  
**Suite nib:** ZETA0–6 · LULU0–5 · SETU0–SETU6.5 · HOLD0–HOLD1 · HOLD-W · STOA0–40  
**Git nib:** *(pin after seat)* STOA40 cue nest jam left  
...
**STOA40** cue nest jam left GREEN `20260719.150634` — `(cue (jam (mix …) …))` under face · arms · open `++`. Next door: **STOA41** check-in.

Smoke: `rishi/bin/rishi run tools/glow_run.rish glow/gen/face-cue-jam-nest.glow`

Pitfalls: Zig `packed` → `cell_pack` · nest-left faces `face`/`face2`/`face3` · expect **3** (face) · core unpack **5**.
...
| **STOA** | Glow language SLC · nest · composition | **STOA0–40 GREEN** · cue nest jam left · STOA41 next |
...
| Door | Kind |
|------|------|
| **STOA41** next language toward product-in-Glow | **check-in** |
