...
**Last refreshed:** `20260720.200022` (UTC cloud) · voice Quin  
**Product nib:** ZETA6 · LULU0–5 · **SETU6.5** · HOLD0–HOLD1 · HOLD-W  
**Language nib:** **STOA0–136** GREEN · STOA137 open  
**Suite nib:** ZETA0–6 · LULU0–5 · SETU0–SETU6.5 · HOLD0–HOLD1 · HOLD-W · STOA0–136  
**Git nib:** `aa460089fb` — STOA136 triple-mold flip  
...
**STOA136** seated · triple-mold flip (`%-  flip` · from↔amount · fee stays · 5/3/1 → 3/5/1).  
**STOA137** next — lean A map: **quad-mold flip** call-body (Sala B0 Framework).
...
Hold on iOS: ambient gold · bartis stated · named allowlist amount/count/kind/xact/xfer/pair/triple/quad · closed call gates double/inc/dec/flip. Defer Pixel/SETU / Sala B0 to Framework.
...
| **STOA** | Glow language SLC · nest · composition | **STOA0–136 GREEN** · STOA137 next |
...
| Door | Kind |
|------|------|
| **STOA137** quad-mold flip call-body (lean A) · penta · tagged argv · gold held | **open** — map seated; Sala B0 Framework |
