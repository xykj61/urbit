...
**Last refreshed:** `20260719.201819` (Eastern) · voice Quin  
**Product nib:** ZETA6 · LULU0–5 · **SETU6.5** · HOLD0–HOLD1 · HOLD-W  
**Language nib:** **STOA0–85** GREEN · STOA86 open  
**Suite nib:** ZETA0–6 · LULU0–5 · SETU0–SETU6.5 · HOLD0–HOLD1 · HOLD-W · STOA0–85  
**Git nib:** `08b0a63d60` STOA85 cross-desk token peek  
...
**STOA85** cross-desk named-cast peek via tokens GREEN `20260719.201500` — `tokens.looks_like_cross_desk` drives `/+` then `^-` dispatch; `lower_named_cast` delegates; same-desk and mold-only stay false; desk suite GREEN. Next door: **STOA86** check-in.

Smoke: `rishi/bin/rishi run tools/glow_tokens_witness.rish`

Pitfalls: peek is dispatch only · lowers still parse bytes. Hold: token-driven lower slice · mold peek · Sala B0 rewrite.
...
| **STOA** | Glow language SLC · nest · composition | **STOA0–85 GREEN** · both cast peeks · STOA86 next |
...
| Door | Kind |
|------|------|
| **STOA86** next language (token lower · mold peek · Sala B0) | **check-in** |
