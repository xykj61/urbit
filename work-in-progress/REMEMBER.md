...
**Last refreshed:** `20260719.171500` (Eastern) · voice Quin  
...
**STOA60** `/+` nest-both cue-of-jam GREEN `20260719.171500` — import `lib-core-cue-jam-both-nest`, call `unpack`. Next door: **STOA61** check-in.

Smoke: `rishi/bin/rishi run tools/glow_run.rish glow/gen/use-lib-cue-jam-both-nest.glow`

Pitfalls: both mixes zero · expect **0**. `/+` nest cue-jam ladder closed.
...
| **STOA** | Glow language SLC · nest · composition | **STOA0–60 GREEN** · `/+` nest-both cue-of-jam · STOA61 next |
...
| Door | Kind |
|------|------|
| **STOA61** next language toward product-in-Glow | **check-in** |
