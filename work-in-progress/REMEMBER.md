...
**Last refreshed:** `20260719.151831` (Eastern) · voice Quin  
**Product nib:** ZETA6 · LULU0–5 · **SETU6.5** · HOLD0–HOLD1 · HOLD-W  
**Language nib:** **STOA0–41** GREEN · STOA42 open  
**Suite nib:** ZETA0–6 · LULU0–5 · SETU0–SETU6.5 · HOLD0–HOLD1 · HOLD-W · STOA0–41  
**Git nib:** *(pin after seat)* STOA41 cue nest jam right  
...
**STOA41** cue nest jam right GREEN `20260719.151831` — `(cue (jam … (mix …)))` under face · arms · open `++`. Next door: **STOA42** check-in.

Smoke: `rishi/bin/rishi run tools/glow_run.rish glow/gen/face-cue-jam-right-nest.glow`

Pitfalls: Zig `packed` → `cell_pack` · never shadow `rn` in `lower_null` · face expect **6** · core unpack **0**.
...
| **STOA** | Glow language SLC · nest · composition | **STOA0–41 GREEN** · cue nest jam right · STOA42 next |
...
| Door | Kind |
|------|------|
| **STOA42** next language toward product-in-Glow | **check-in** |
