...
**Last refreshed:** `20260720.180900` (UTC cloud · Eastern season) · voice Quin  
**Product nib:** ZETA6 · LULU0–5 · **SETU6.5** · HOLD0–HOLD1 · HOLD-W  
**Language nib:** **STOA0–117** GREEN · STOA118 open  
**Suite nib:** ZETA0–6 · LULU0–5 · SETU0–SETU6.5 · HOLD0–HOLD1 · HOLD-W · STOA0–117  
**Git nib:** (await send) STOA117 barket TAME tidy  
...
**STOA117** GREEN · barket TAME tidy (`append_print` · `parse_body` · ban seat). Await send.  
**STOA118** next — check-in before wet accept.
...
Hold on iOS: ambient wet/gold *accept* · open named-mold set. Defer Pixel/SETU / Sala B0 to Framework.
...
| **STOA** | Glow language SLC · nest · composition | **STOA0–117 GREEN** · STOA118 next |
...
| Door | Kind |
|------|------|
| **STOA118** wet accept · Sala B0 | **check-in** — iOS season |
| Wet/gold · ambient wet *accept* | **held** |
