...
**Last refreshed:** `20260720.195943` (UTC cloud) · voice Quin  
...
**Git nib:** *(pin after send)* — STOA136 triple-mold flip  
...
**STOA137** next — compass pick: gold · tagged argv · quad flip · penta-mold (Sala B0 Framework).
...
| Door | Kind |
|------|------|
| **STOA137** gold · tagged argv · quad flip · penta-mold | **open** — thicker doors; Sala B0 Framework |
