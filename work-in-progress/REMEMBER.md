...
**Last refreshed:** `20260720.194143` (UTC cloud) · voice Quin  
**Product nib:** ZETA6 · LULU0–5 · **SETU6.5** · HOLD0–HOLD1 · HOLD-W  
**Language nib:** **STOA0–133** GREEN · STOA134 open  
**Suite nib:** ZETA0–6 · LULU0–5 · SETU0–SETU6.5 · HOLD0–HOLD1 · HOLD-W · STOA0–133  
**Git nib:** *(pin after send)* — STOA133 count-mold argv  
...
**STOA133** seated · count-mold argv (`gate-count-u32` · `gate-barket-count-u32`).  
**STOA134** next — compass pick: gold · argv under tagged/pair · triple-mold (Sala B0 Framework).
...
| **STOA** | Glow language SLC · nest · composition | **STOA0–133 GREEN** · STOA134 next |
...
| Door | Kind |
|------|------|
| **STOA134** gold · tagged/pair argv · triple-mold | **open** — thicker doors; Sala B0 Framework |
