...
**Last refreshed:** `20260719.163527` (Eastern) · voice Quin  
**Product nib:** ZETA6 · LULU0–5 · **SETU6.5** · HOLD0–HOLD1 · HOLD-W  
**Language nib:** **STOA0–51** GREEN · STOA52 open  
**Suite nib:** ZETA0–6 · LULU0–5 · SETU0–SETU6.5 · HOLD0–HOLD1 · HOLD-W · STOA0–51  
**Git nib:** *(pin after seat)* STOA51 bind→inline nest-right cue-of-jam  
...
**STOA51** bind→inline nest-right cue-of-jam GREEN `20260719.163527` — authored faces into nest-right `(cue (jam … (mix …)))`. Next door: **STOA52** check-in.

Smoke: `rishi/bin/rishi run tools/glow_run.rish glow/gen/compose-bind-inline-nest-right-cue-jam.glow`

Pitfalls: jam-left reuses mix-left · nest-both under binds refused · expect = from ^ amount (**6**).
...
| **STOA** | Glow language SLC · nest · composition | **STOA0–51 GREEN** · bind→inline nest-right · STOA52 next |
...
| Door | Kind |
|------|------|
| **STOA52** next language toward product-in-Glow | **check-in** |
