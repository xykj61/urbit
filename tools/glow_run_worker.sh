...
*)
  test -z "$SAMPLE" || {
    echo "FAIL: only sample-u32 / gate-*-u32 / gate-*-kind-tag / gate-*-xact-tag / gate-*-xfer-tag / gate-*-pair-fields / gate-*-triple-fields / gate-*-quad-fields / gate-*-penta-fields / gate-*-hexa-fields / gate-*-hepta-fields take a sample"
    exit 2
  }
  ;;
esac
