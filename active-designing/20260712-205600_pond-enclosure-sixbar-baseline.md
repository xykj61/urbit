# Pond enclosure six-bar baseline (ai-jail today)
...
Meta: `tools/.cache/pond-enclosure/sixbar-baseline-meta.txt` (gitignored cache).

**Living scorecard (two columns):** [`20260712-210800_pond-enclosure-scorecard-two-column.md`](20260712-210800_pond-enclosure-scorecard-two-column.md).

## Six bars (column one — incumbent)
...
| 6 | Three refusals + bus measure | kvm-off · no D-Bus KVM path · host home refuse · **three-door bus** recorded |

## Gap row (bar6 three doors)

Baseline records each door; pond-required wants all three closed (env empty · socket absent · netns unshared). Policy-path refuse is a door with paired customs — never ambient. See scorecard.
...
*May the scorecard stay honest, the gap keep its row, and Pond earn the jail’s job by out-refusing it.*
