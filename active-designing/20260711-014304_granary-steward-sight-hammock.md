...
*Tip **424** proved Granary list → settle → Greencandy on Skate. Tip **425** folds the weave steward’s own books onto that same glass — second-roof mirror of Mandi tip **423**.*
...
2. Greencandy welcome + weave sale → cash **900**, conservation **0**
