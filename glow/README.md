...
**Language:** EN
**Last updated:** 2026-07-18 (**STOA15–16** two-arm core · library emit · TAME + Acme first-code pointers)
**Style:** Radiant (see `../context/RADIANT_STYLE.md`)
**Voice:** Quin
**Audience:** Acme Corporation employees reading the working Glow pin
**Status:** Checkable — **STOA0–16** sixteen heads · two-arm core · library emit · multi-line · compose · nests · cells · `%` calls · truth, GREEN
...
| [`rune_core.rye`](rune_core.rye) | `\|%` | Thin core — one or two `++` arms, closed with `--` (STOA14–15) |

## Generator hop

All sixteen single-line heads lower today; multi-line adds compose, typed faces, and `|%` cores (one or two arms, plus library emit). Desk files live under [`gen/`](gen/). Rishi hand: [`../tools/glow_run.rish`](../tools/glow_run.rish) · desk witness: [`../tools/glow_run_desk_witness.rish`](../tools/glow_run_desk_witness.rish). Briefs: [`../active-designing/20260718-223906_stoa14-cores-thin-battery-brief.md`](../active-designing/20260718-223906_stoa14-cores-thin-battery-brief.md) · [`../active-designing/20260718-225150_stoa15-16-two-arm-and-library-brief.md`](../active-designing/20260718-225150_stoa15-16-two-arm-and-library-brief.md).

```bash
rishi/bin/rishi run tools/glow_run.rish glow/gen/core-two.glow
