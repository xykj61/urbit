...
**Status:** Checkable — operator compressor (preference ladder closed · SETU0–SETU2 GREEN)  
**Depth:** guide  
**Ceiling:** ≤80 lines  
...
4. **SETU2** — approved and built: that ping crosses localhost UDP (Setu stand-in). CDC-NCM is **SETU3**.  
5. Amber/Amphora fuse declined — compose later (`20260718.133455`).  
6. Intended used-Pixel posture: `cell · off` + `wire · usb_desk`.
