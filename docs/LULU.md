...
**Status:** Checkable — operator compressor (preference ladder closed · SETU0–SETU1 GREEN)  
**Depth:** guide  
**Ceiling:** ≤80 lines  
...
| **SETU2** | CDC-NCM gadget lane | open — check-in |
...
3. **SETU1** — approved and built: `usb_desk` seals one Comlink lane ping; `local` refuses/SKIP. CDC-NCM is **SETU2**.  
4. Amber/Amphora fuse declined — compose later (`20260718.133455`).  
5. Intended used-Pixel posture: `cell · off` + `wire · usb_desk`.
