# STOA — Glow SLC · nest · product · ≤80 · STOA0–88 GREEN · 2026-07-19 (?> ?<) · draw → **STOA**
...
| **STOA84–88** | Cast peeks · TAME tok/cast · `?>`/`?<` asserts | tokens · named-cast · assert | **GREEN** `201027`…`203207` |
Smoke: `rishi/bin/rishi run tools/glow_lower_assert_witness.rish` · Sibling: **ZETA** · **LULU** · **SETU** · **TUBE**.