# STOA — Glow SLC · nest · product · ≤80 · STOA0–85 GREEN · 2026-07-19 (xdesk peek) · draw → **STOA**
...
| **STOA84–85** | Same-/cross-desk named-cast token peeks | `glow_tokens_witness` · desk | **GREEN** `201027` · `201500` |
