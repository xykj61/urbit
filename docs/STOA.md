...
**Status:** Checkable — operator compressor (STOA0–STOA17 GREEN)  
**Depth:** guide  
**Ceiling:** ≤80 lines  
**Last updated:** 2026-07-18 (STOA17 core payload GREEN)  
...
| **STOA18** | Face→core · 3+ arms · typed payload | horizon — check-in | horizon |
