# STOA — Glow SLC · nest · product · ≤80 · STOA0–78 GREEN · 2026-07-19 ($% payload) · draw → **STOA**
...
| **STOA76–78** | `$%` · named-cast · `$%` payload arms | mold · named-cast · desk | **GREEN** `192936` · `193538` · `193907` |
| **STOA79** | Next language / product | horizon — check-in | horizon |
