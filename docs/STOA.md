# STOA — Glow SLC · nest · product · ≤80 · STOA0–79 GREEN · 2026-07-19 (cross-cast) · draw → **STOA**
...
| **STOA76–79** | `$%` · named-cast · payload · cross-desk cast | mold · named-cast · desk | **GREEN** `192936`…`194711` |
| **STOA80** | Next language / product | horizon — check-in | horizon |
Smoke: `rishi/bin/rishi run tools/glow_lower_named_cast_witness.rish` · Sibling: **ZETA** · **LULU** · **SETU** · **TUBE**.