...
**Status:** Checkable — operator compressor (STOA0–STOA44 GREEN)  
**Depth:** guide  
**Ceiling:** ≤80 lines  
**Last updated:** 2026-07-19 (STOA44 bind→nest-jam→cue GREEN)  
...
| **STOA45** | Next language / product | horizon — check-in | horizon |

## Hands-on
```bash
cd ~/urbit
rishi/bin/rishi run tools/glow_run.rish glow/gen/compose-bind-nest-jam-cue.glow
