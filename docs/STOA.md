...
**Status:** Checkable — operator compressor (STOA0–STOA18 GREEN)  
**Depth:** guide  
**Ceiling:** ≤80 lines  
**Last updated:** 2026-07-18 (STOA18 face→core GREEN)  
...
| **STOA19** | 3+ arms · typed payload · richer compose | horizon — check-in | horizon |
