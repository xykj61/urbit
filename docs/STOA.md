# STOA — Glow SLC · nest · product · ≤80 · STOA0–91 GREEN · 2026-07-19 (G2 pin) · draw → **STOA**
...
| **STOA84–91** | Cast peeks · TAME · `?>`/`?<` · alphabet G0–G2 | tokens · assert · `glow_rune_alphabet_witness` | **GREEN** `201027`…`222657` |
