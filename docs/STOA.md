...
**Status:** Checkable — operator compressor (STOA0–STOA23 GREEN)  
**Depth:** guide  
**Ceiling:** ≤80 lines  
**Last updated:** 2026-07-18 (STOA23 two-face→add core GREEN)  
...
| **STOA24** | Face→payload compose · more | horizon — check-in | horizon |
