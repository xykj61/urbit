...
**Status:** Checkable — STOA0–STOA65 GREEN · 2026-07-19 (`/+` payload cue-of-jam) · guide · ≤80  
...
| **STOA66** | Next language / product | horizon — check-in | horizon |
```bash
cd ~/urbit && rishi/bin/rishi run tools/glow_run.rish glow/gen/use-lib-payload-cue-jam.glow && rishi/bin/rishi run tools/glow_run_desk_witness.rish
```
