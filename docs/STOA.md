...
**Status:** Checkable — operator compressor (STOA0–STOA20 GREEN)  
**Depth:** guide  
**Ceiling:** ≤80 lines  
**Last updated:** 2026-07-18 (STOA19–20 two-arm compose · three-arm GREEN)  
...
| **STOA21** | Typed payload · face→3 · richer compose | horizon — check-in | horizon |
