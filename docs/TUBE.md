...
**Dexter D0–D3 on glass GREEN `20260717.173133` · Pixel look D2 `20260717.174336` · live KEY D3 `20260717.174551`:** pure Dexter LineEditor (`pond/apps/window_input.rye`); demo paints `DEXTER line · glow` on row 12; title gains `DX`. D3: `dexter_glass_key.rye` maps Android KEY downs → Action; NativeActivity drains live keys, refreshes the line, and calls `ANativeActivity_showSoftInput`. Witness + pack GREEN. Pixel look for live typing is the host-install eyes slice.
