...
**Dexter D0+D1+D2 on glass GREEN `20260717.173133` · Pixel `20260717.174336`:** pure Dexter LineEditor (`pond/apps/window_input.rye`) fed demo key actions; glass paints `DEXTER line · glow` on row 12; title gains `DX`. Witness `tools/dexter_glass_witness.rish` GREEN; pack GREEN; Keaton confirmed Pixel look. Soft-keyboard live drain stays later.
