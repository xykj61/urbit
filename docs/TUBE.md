...
**Dexter D0+D1 on glass GREEN `20260717.173133`:** pure Dexter LineEditor (`pond/apps/window_input.rye`) fed demo key actions; glass paints `DEXTER line · glow` on row 12; title gains `DX`. Witness `tools/dexter_glass_witness.rish` GREEN; pack GREEN. Pixel look (D2) is the host install slice. Soft-keyboard live drain stays later.
