...
| Install APK + prove Sala root | Host terminal: `tools/tube05_install_proof_onpath_host.rish` — **HAWM0** · **Pixel** · glass through TUBE4 + Sala B1 carriage (Pixel look `20260717.171015`) |
