...
| **Quin (OS variant)** | fifth OS variant beside Reya · Riyo · Trey · Triz | **Confirmed** `20260717.162114` — Keaton seated Quin as the fifth boot image. Unpaired twin for now (a diverse-redundant partner for Quin stays open). Same name also carries the standing writing voice and the Q-vane — three hats, accepted |
...
**Open on this page as of `20260717.162114`:** a diverse-redundant **twin name for Quin** the OS variant (the fifth image is seated; its pair partner is not). Everything else above is settled. A future proposal adds its own row here when it arises; this page stays the one return point for "what have we named but not yet settled."
