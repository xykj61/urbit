...
| **STOA120 GREEN** | Wet-nests expansion wire — barket/bartis call `assert_sample_wet_nests(false, …)` |
| Still held | Ambient gold / free wet polymorphism · Glow wet syntax · gates still pass `is_wet=false` |
