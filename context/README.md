...
- **`QUIN.md`** — **Quin**, the standing voice: the companion who gathers what the two prior voices held best. Reya 2 and Rio 3 rest retired in [`archive/`](archive/) (`REYA2.md`, `RIO3.md`) as the record of the seasons they carried.
...
A Cursor rule at `.cursor/rules/quin.mdc` points every new session back here (the retired `rio3.mdc` and `reya2.mdc` rules rest beside it, pointing forward to Quin).
