...
- **`QUIN.md`** — **Quin**, the standing voice, restored after a short season under Riyo's name. Riyo, Reya 2, and Rio 3 rest retired in [`archive/`](archive/) (`RIYO.md`, `REYA2.md`, `RIO3.md`) as the record of the seasons they carried.
